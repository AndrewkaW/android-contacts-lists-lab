...
public class ContactType {
    ...
    public static String[] getContactTypes() {
       String [] listContactType = {TELEGRAM, WHATS_APP, VIBER, SIGNAL, THREEMA, PHONE, EMAIL};
       return listContactType; // метод должен возвращать массив строк, перечисленных выше
    }
}
